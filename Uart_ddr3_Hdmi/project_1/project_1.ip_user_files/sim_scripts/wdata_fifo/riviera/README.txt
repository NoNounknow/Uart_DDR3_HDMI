...
#
# Generated by export_simulation on Sun Nov 05 21:09:28 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './wdata_fifo.sh' script.

./wdata_fifo.sh -reset_run
...
./wdata_fifo.sh -noclean_files

For more information on the script, please type './wdata_fifo.sh -help'.
