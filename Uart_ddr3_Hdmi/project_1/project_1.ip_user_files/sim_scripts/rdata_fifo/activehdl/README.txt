...
#
# Generated by export_simulation on Sun Nov 05 21:10:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './rdata_fifo.sh' script.

./rdata_fifo.sh -reset_run
...
./rdata_fifo.sh -noclean_files

For more information on the script, please type './rdata_fifo.sh -help'.
