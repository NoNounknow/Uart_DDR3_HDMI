...
-- Date        : Sun Nov  5 14:53:45 2023
-- Host        : LAPTOP-H1858A6E running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/three_verilog/Uart_ddr3_Hdmi/project_1/project_1.gen/sources_1/ip/clk_wiz_1/clk_wiz_1_sim_netlist.vhdl
-- Design      : clk_wiz_1
...
architecture STRUCTURE of clk_wiz_1_clk_wiz is
  signal clk_100_IN_clk_wiz_1 : STD_LOGIC;
  signal clk_5xPIXEL_clk_wiz_1 : STD_LOGIC;
  signal clk_PIXEL_clk_wiz_1 : STD_LOGIC;
...
clkin1_bufg: unisim.vcomponents.BUFG
     port map (
      I => clk_100_IN,
      O => clk_100_IN_clk_wiz_1
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_PIXEL_clk_wiz_1,
      O => clk_PIXEL
    );
clkout2_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_5xPIXEL_clk_wiz_1,
      O => clk_5xPIXEL
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKIN1 => clk_100_IN_clk_wiz_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_PIXEL_clk_wiz_1,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_5xPIXEL_clk_wiz_1,
