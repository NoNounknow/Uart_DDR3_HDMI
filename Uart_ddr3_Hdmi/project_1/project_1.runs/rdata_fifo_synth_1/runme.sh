...
HD_PWD='D:/three_verilog/Uart_ddr3_Hdmi/project_1/project_1.runs/rdata_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rdata_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rdata_fifo.tcl
