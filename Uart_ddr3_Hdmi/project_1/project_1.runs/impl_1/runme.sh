...
HD_PWD='D:/three_verilog/Uart_ddr3_Hdmi/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart2DDR3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uart2DDR3_top.tcl -notrace
