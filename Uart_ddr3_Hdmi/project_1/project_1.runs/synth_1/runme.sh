...
HD_PWD='D:/three_verilog/Uart_ddr3_Hdmi/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart2DDR3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart2DDR3_top.tcl
